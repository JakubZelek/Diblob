...
MIN_NUM_OF_NODES = 201
MAX_NUM_OF_NODES = 1000
TIMEOUT = 600*12
FLOOR_TIMEOUT = 600
        ...
        for graph in data:
            try:
                ...
                if num_of_prime_paths >= 5000:
                    ...
                    with open("Diblob/notebooks/experiments/prime_paths_papier/resultsv/201_1000.jsonl", "a") as f:

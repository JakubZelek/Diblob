...
MIN_NUM_OF_NODES = 101
MAX_NUM_OF_NODES = 200
TIMEOUT = 600*6
FLOOR_TIMEOUT = 600
        ...
        for graph in data:
            try:
                ...
                if num_of_prime_paths >= 5000:
                    ...
                    with open("Diblob/notebooks/experiments/prime_paths_papier/resultsv/101_250.jsonl", "a") as f:
